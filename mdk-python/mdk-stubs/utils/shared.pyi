from mdk.types.builtins import BoolType as BoolType, FloatType as FloatType, IntType as IntType, StringType as StringType
...
def convert(input: Expression | str | int | float | bool) -> Expression: ...
