...
ADDRESS_MUGEN_11B1 = {
    ...
    "SCTRL_BREAKPOINT_FUNC": [
        ...
        0x5A, 0x5B, 0x58, # pops
        0x83, 0x3E, 0x00, # cmp [esi], 0
        0x0F, 0x85, 0x4C, 0xE8, 0xF7, 0xFF, # jne 45C25F
        0xE9, 0xE2, 0xE7, 0xF7, 0xFF # jmp 45c1fa
    ],
    "SCTRL_PASSPOINT_FUNC": [
        ...
        0xEB, 0xE7, # jmp .loop_breaks
        0x5A, 0x5B, 0x58, # pops
        0xE8, 0xB1, 0xB4, 0xF6, 0xFF, # call 0x448f50
        0xE9, 0xA4, 0xE7, 0xF7, 0xFF # jmp 45c248
    ],
    "game": 0x5040E8,
    "player": 0x12278,
    "stateno": 0xCCC,
