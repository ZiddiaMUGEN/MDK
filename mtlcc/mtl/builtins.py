...
def getBaseTriggers() -> list[TriggerDefinition]:
    return [
        ...
        TriggerDefinition("asin", BUILTIN_FLOAT, None, [TypeParameter("exprn", BUILTIN_NUMERIC)], None, Location("mtl/builtins.py", line_number()), category = TriggerCategory.BUILTIN),
        TriggerDefinition("atan", BUILTIN_FLOAT, None, [TypeParameter("exprn", BUILTIN_NUMERIC)], None, Location("mtl/builtins.py", line_number()), category = TriggerCategory.BUILTIN),
        ...
        TriggerDefinition("exp", BUILTIN_FLOAT, None, [TypeParameter("exprn", BUILTIN_NUMERIC)], None, Location("mtl/builtins.py", line_number()), category = TriggerCategory.BUILTIN),
        ...
        TriggerDefinition("ln", BUILTIN_FLOAT, None, [TypeParameter("exprn", BUILTIN_NUMERIC)], None, Location("mtl/builtins.py", line_number()), category = TriggerCategory.BUILTIN),
        TriggerDefinition("log", BUILTIN_FLOAT, None, [TypeParameter("exp1", BUILTIN_NUMERIC)], None, Location("mtl/builtins.py", line_number()), category = TriggerCategory.BUILTIN),
        ...
        TriggerDefinition("tan", BUILTIN_FLOAT, None, [TypeParameter("exprn", BUILTIN_NUMERIC)], None, Location("mtl/builtins.py", line_number()), category = TriggerCategory.BUILTIN),
