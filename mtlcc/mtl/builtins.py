...
def getBaseTriggers() -> List[TriggerDefinition]:
    return [
        ...
        TriggerDefinition("AnimExist", "bool", None, [TriggerParameter("exprn", "anim")], None, Location("mtl/builtins.py", line_number())),
        ...
        TriggerDefinition("Const", "numeric", None, [TriggerParameter("param_name", "string")], None, Location("mtl/builtins.py", line_number())),
        ...
        TriggerDefinition("GetHitVar", "numeric", None, [TriggerParameter("param_name", "string")], None, Location("mtl/builtins.py", line_number())),
        ...
        #TriggerDefinition("HitVel", "vector2", None, [], None, Location("mtl/builtins.py", line_number())),
        ...
        #TriggerDefinition("P2BodyDist", "vector2", None, [], None, Location("mtl/builtins.py", line_number())),
        #TriggerDefinition("P2Dist", "vector2", None, [], None, Location("mtl/builtins.py", line_number())),
        ...
        #TriggerDefinition("ParentDist", "vector2", None, [], None, Location("mtl/builtins.py", line_number())),
        TriggerDefinition("pi", "float", None, [], None, Location("mtl/builtins.py", line_number())),
        #TriggerDefinition("Pos", "vector2", None, [], None, Location("mtl/builtins.py", line_number())),
        ...
        #TriggerDefinition("RootDist", "vector2", None, [], None, Location("mtl/builtins.py", line_number())),
        ...
        #TriggerDefinition("ScreenPos", "vector2", None, [], None, Location("mtl/builtins.py", line_number())),
        TriggerDefinition("SelfAnimExist", "bool", None, [TriggerParameter("exprn", "anim")], None, Location("mtl/builtins.py", line_number())),
        ...
        TriggerDefinition("StageVar", "string", None, [TriggerParameter("param_name", "string")], None, Location("mtl/builtins.py", line_number())),
        ...
        #TriggerDefinition("Vel", "vector2", None, [], None, Location("mtl/builtins.py", line_number())),
...
def getBaseTemplates() -> List[TemplateDefinition]:
    return [
        TemplateDefinition("AfterImage", [TemplateParameter("time", "int", False), TemplateParameter("length", "int", False), TemplateParameter("palcolor", "int", False), TemplateParameter("palinvertall", "bool", False), TemplateParameter("palbright", "color", False), TemplateParameter("palcontrast", "color", False), TemplateParameter("palpostbright", "color", False), TemplateParameter("paladd", "color", False), TemplateParameter("palmul", "color[float]", False), TemplateParameter("timegap", "int", False), TemplateParameter("framegap", "int", False), TemplateParameter("trans", "string", False)], [], [], Location("mtl/builtins.py", line_number()), TemplateCategory.BUILTIN),
        ...
        TemplateDefinition("AngleDraw", [TemplateParameter("value", "float", False), TemplateParameter("scale", "vector", False)], [], [], Location("mtl/builtins.py", line_number()), TemplateCategory.BUILTIN),
        ...
        TemplateDefinition("AssertSpecial", [TemplateParameter("flag", "string", True), TemplateParameter("flag2", "string", False), TemplateParameter("flag3", "string", False)], [], [], Location("mtl/builtins.py", line_number()), TemplateCategory.BUILTIN),
        ...
        TemplateDefinition("BindToParent", [TemplateParameter("time", "int", False), TemplateParameter("facing", "int", False), TemplateParameter("pos", "vector", False)], [], [], Location("mtl/builtins.py", line_number()), TemplateCategory.BUILTIN),
        TemplateDefinition("BindToRoot", [TemplateParameter("time", "int", False), TemplateParameter("facing", "int", False), TemplateParameter("pos", "vector", False)], [], [], Location("mtl/builtins.py", line_number()), TemplateCategory.BUILTIN),
        TemplateDefinition("BindToTarget", [TemplateParameter("time", "int", False), TemplateParameter("id", "int", False), TemplateParameter("pos", "vector[float, float, string]", False)], [], [], Location("mtl/builtins.py", line_number()), TemplateCategory.BUILTIN),
        TemplateDefinition("ChangeAnim", [TemplateParameter("value", "anim", True), TemplateParameter("elem", "int", False)], [], [], Location("mtl/builtins.py", line_number()), TemplateCategory.BUILTIN),
        TemplateDefinition("ChangeAnim2", [TemplateParameter("value", "anim", True), TemplateParameter("elem", "int", False)], [], [], Location("mtl/builtins.py", line_number()), TemplateCategory.BUILTIN),
        TemplateDefinition("ChangeState", [TemplateParameter("value", "statedef", True), TemplateParameter("ctrl", "bool", False), TemplateParameter("anim", "int", False)], [], [], Location("mtl/builtins.py", line_number()), TemplateCategory.BUILTIN),
        ...
        TemplateDefinition("EnvColor", [TemplateParameter("value", "color", False), TemplateParameter("time", "int", False), TemplateParameter("under", "bool", False)], [], [], Location("mtl/builtins.py", line_number()), TemplateCategory.BUILTIN),
        ...
        TemplateDefinition("Explod", [TemplateParameter("anim", "anim", True), TemplateParameter("id", "int", False), TemplateParameter("pos", "vector[int]", False), TemplateParameter("postype", "string", False), TemplateParameter("facing", "int", False), TemplateParameter("vfacing", "int", False), TemplateParameter("bindtime", "int", False), TemplateParameter("vel", "vector", False), TemplateParameter("accel", "vector", False), TemplateParameter("random", "vector[int]", False), TemplateParameter("removetime", "int", False), TemplateParameter("supermove", "bool", False), TemplateParameter("supermovetime", "int", False), TemplateParameter("pausemovetime", "int", False), TemplateParameter("scale", "vector", False), TemplateParameter("sprpriority", "int", False), TemplateParameter("ontop", "bool", False), TemplateParameter("shadow", "color", False), TemplateParameter("ownpal", "bool", False), TemplateParameter("removeongethit", "bool", False), TemplateParameter("ignorehitpause", "bool", False), TemplateParameter("trans", "string", False)], [], [], Location("mtl/builtins.py", line_number()), TemplateCategory.BUILTIN),
        ...
        TemplateDefinition("HitOverride", [TemplateParameter("attr", "string", True), TemplateParameter("stateno", "statedef", True), TemplateParameter("slot", "int", False), TemplateParameter("time", "int", False), TemplateParameter("forceair", "bool", False)], [], [], Location("mtl/builtins.py", line_number()), TemplateCategory.BUILTIN),
        ...
        TemplateDefinition("MakeDust", [TemplateParameter("pos", "vector[int]", False), TemplateParameter("pos2", "vector[int]", False), TemplateParameter("spacing", "int", False)], [], [], Location("mtl/builtins.py", line_number()), TemplateCategory.BUILTIN),
        TemplateDefinition("ModifyExplod", [TemplateParameter("id", "int", True), TemplateParameter("anim", "anim", False), TemplateParameter("pos", "vector[int]", False), TemplateParameter("postype", "string", False), TemplateParameter("facing", "int", False), TemplateParameter("vfacing", "int", False), TemplateParameter("bindtime", "int", False), TemplateParameter("vel", "vector", False), TemplateParameter("accel", "vector", False), TemplateParameter("random", "vector[int]", False), TemplateParameter("removetime", "int", False), TemplateParameter("supermove", "bool", False), TemplateParameter("supermovetime", "int", False), TemplateParameter("pausemovetime", "int", False), TemplateParameter("scale", "vector", False), TemplateParameter("sprpriority", "int", False), TemplateParameter("ontop", "bool", False), TemplateParameter("shadow", "color", False), TemplateParameter("ownpal", "bool", False), TemplateParameter("removeongethit", "bool", False), TemplateParameter("ignorehitpause", "bool", False), TemplateParameter("trans", "string", False)], [], [], Location("mtl/builtins.py", line_number()), TemplateCategory.BUILTIN),
        TemplateDefinition("MoveHitReset", [], [], [], Location("mtl/builtins.py", line_number()), TemplateCategory.BUILTIN),
        TemplateDefinition("NotHitBy", [TemplateParameter("value", "string", False), TemplateParameter("value2", "string", False), TemplateParameter("time", "int", False)], [], [], Location("mtl/builtins.py", line_number()), TemplateCategory.BUILTIN),
        ...
        TemplateDefinition("PalFX", [TemplateParameter("time", "int", False), TemplateParameter("add", "color", False), TemplateParameter("mul", "color", False), TemplateParameter("sinadd", "vector[int]", False), TemplateParameter("invertall", "bool", False), TemplateParameter("color", "int", False)], [], [], Location("mtl/builtins.py", line_number()), TemplateCategory.BUILTIN),
        TemplateDefinition("ParentVarAdd", [TemplateParameter("v", "int", True), TemplateParameter("fv", "int", True), TemplateParameter("sv", "int", True), TemplateParameter("sfv", "int", True), TemplateParameter("value", "float", True)], [], [], Location("mtl/builtins.py", line_number()), TemplateCategory.BUILTIN),
        TemplateDefinition("ParentVarSet", [TemplateParameter("v", "int", True), TemplateParameter("fv", "int", True), TemplateParameter("sv", "int", True), TemplateParameter("sfv", "int", True), TemplateParameter("value", "float", True)], [], [], Location("mtl/builtins.py", line_number()), TemplateCategory.BUILTIN),
        ...
        TemplateDefinition("ReversalDef", [TemplateParameter("reversal.attr", "string", True), TemplateParameter("pausetime", "vector[int]", False), TemplateParameter("sparkno", "anim", False), TemplateParameter("hitsound", "sound", False), TemplateParameter("p1stateno", "statedef", False), TemplateParameter("p2stateno", "statedef", False), TemplateParameter("p1sprpriority", "int", False), TemplateParameter("p2sprpriority", "int", False), TemplateParameter("sparkxy", "vector[int]", False)], [], [], Location("mtl/builtins.py", line_number()), TemplateCategory.BUILTIN),
        TemplateDefinition("ScreenBound", [TemplateParameter("value", "bool", False), TemplateParameter("movecamera", "vector[bool]", False)], [], [], Location("mtl/builtins.py", line_number()), TemplateCategory.BUILTIN),
        TemplateDefinition("SelfState", [TemplateParameter("value", "statedef", True), TemplateParameter("ctrl", "bool", False), TemplateParameter("anim", "int", False)], [], [], Location("mtl/builtins.py", line_number()), TemplateCategory.BUILTIN),
        ...
        TemplateDefinition("StateTypeSet", [TemplateParameter("statetype", "string", False), TemplateParameter("movetype", "string", False), TemplateParameter("physics", "string", False)], [], [], Location("mtl/builtins.py", line_number()), TemplateCategory.BUILTIN),
        ...
        TemplateDefinition("TargetBind", [TemplateParameter("time", "int", False), TemplateParameter("id", "int", False), TemplateParameter("pos", "vector", False)], [], [], Location("mtl/builtins.py", line_number()), TemplateCategory.BUILTIN),
        ...
        TemplateDefinition("Trans", [TemplateParameter("trans", "string", True), TemplateParameter("alpha", "vector[int]", False)], [], [], Location("mtl/builtins.py", line_number()), TemplateCategory.BUILTIN),
        TemplateDefinition("Turn", [], [], [], Location("mtl/builtins.py", line_number()), TemplateCategory.BUILTIN),
        TemplateDefinition("VarAdd", [TemplateParameter("v", "int", True), TemplateParameter("fv", "int", True), TemplateParameter("sv", "int", True), TemplateParameter("sfv", "int", True), TemplateParameter("value", "float", True)], [], [], Location("mtl/builtins.py", line_number()), TemplateCategory.BUILTIN),
        TemplateDefinition("VarSet", [TemplateParameter("v", "int", True), TemplateParameter("fv", "int", True), TemplateParameter("sv", "int", True), TemplateParameter("sfv", "int", True), TemplateParameter("value", "float", True)], [], [], Location("mtl/builtins.py", line_number()), TemplateCategory.BUILTIN),
        TemplateDefinition("VarRandom", [TemplateParameter("v", "int", True), TemplateParameter("range", "vector[int]", False)], [], [], Location("mtl/builtins.py", line_number()), TemplateCategory.BUILTIN),
        ...
        TemplateDefinition("Width", [TemplateParameter("edge", "vector[int]", False), TemplateParameter("player", "vector[int]", False), TemplateParameter("value", "vector[int]", False)], [], [], Location("mtl/builtins.py", line_number()), TemplateCategory.BUILTIN)
    ]